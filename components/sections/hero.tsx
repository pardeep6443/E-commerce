            ...
            >
              ...
              >
                <Button 
                  asChild 
                  size="lg" 
                  className="bg-brand-accent hover:bg-brand-accent/90 text-white font-medium px-8 py-6 text-lg group"
                >
                ...
                <Button 
                  ...
                  variant="outline" 
                  size="lg"
                  className="border-white text-white hover:bg-white hover:text-black font-medium px-8 py-6 text-lg"
                >
